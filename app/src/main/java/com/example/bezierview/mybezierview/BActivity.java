...
public class BActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView.setLayoutManager(new LinearLayoutManager(BActivity.this));
    }
    ...
    class MyAdapter extends RecyclerView.Adapter<MyVH> {
        ...
        public MyVH onCreateViewHolder(ViewGroup parent, int viewType) {
            LayoutInflater inflater = LayoutInflater.from(BActivity.this);
...
//   一、创造出执行动画的主题---imageview
        ...
        final ImageView goods = new ImageView(BActivity.this);
